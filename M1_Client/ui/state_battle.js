if(!__Page.stateBattle)
{
	...
	__Page.stateBattle.onGameLoaded=function(notfirst)
	{
		...
		//	this.endBattleBtn=cssLib.normalBtn.create(this.hudTCBox,[this.hudTCBox.getW()>>1,10,0],keyId,1,textLib.EndBattle);
			...
			this.mc15Icon=this.hudTLBox.appendNewChild({type:"icon",pos:[36,200,0],css:imgLib.getIcon("goldcard",64),w:64,h:64,anchor_h:1,anchor_v:1,display:0});
			this.cubeCardIcon=this.hudTLBox.appendNewChild({type:"icon",pos:[36+100,200,0],css:imgLib.getIcon("cubecard",64),w:64,h:64,anchor_h:1,anchor_v:1,display:0});
			var clanTip=imgLib.getImg("pic_clan_tip");
			this.sameClanPic=this.hudTLBox.appendNewChild({type:"icon",pos:[0,240,0],css:clanTip,display:0,
				fade:1,fade_alpha:0,fade_size:1,fade_pos:[-clanTip.w,240,0]});
		...
		if(this.gameVO)
		{
			...
			//可能掉落代币
			if(this.lootItemsBox)
				this.hudTLBox.removeChild(this.lootItemsBox);
			var itemsY=200;
			if(this.gameVO.oppMC15Flag || this.gameVO.oppBCCFlag)
			{
				if(this.gameVO.sameClanFlag)
					itemsY=240+this.sameClanPic.getH();
				else
					itemsY=240;
			}else
			{
				if(this.gameVO.sameClanFlag)
				{
					this.sameClanPic.setShowPos([0,200-32,0]);
					this.sameClanPic.setFadePos([0-this.sameClanPic.getW(),200-32,0]);
					itemsY=200-32+this.sameClanPic.getH();
				}
				else
					itemsY=200-18;
			}
			if(this.gameVO.lootItems)
			{
				var items=this.gameVO.lootItems;
				var i;
				if(items.length)
				{
					var lootItemsCSS={type:"icon",id:"lootItems",pos:[10,itemsY,0],w:200,h:80,
							items:[
								cssLib.textFineMid.createCSS([0,0,0],textLib["MayGainItems"],200,20,0,0,0,0),
							]
						};
					for(i=0;i<items.length;i++)
					{
						if(i>=4)
							break;
						lootItemsCSS.items.push({type:"icon",pos:[24+i*48,56,0],css:imgLib.getIcon("icon_"+items[i]+"_32"),w:48,h:48,anchor_h:1,anchor_v:1});
					}
					this.lootItemsBox=this.hudTLBox.appendNewChild(lootItemsCSS);
				}
			}
			...
			if(this.gameVO.oppMC15Flag)
				this.cubeCardIcon.setPos([36+100,200,0]);
			else
				this.cubeCardIcon.setPos([36,200,0]);
			this.cubeCardIcon.setDisplay(this.gameVO.oppBCCFlag?1:0);
		}
		...
		if(!this.gameVO)
		{
			...
			{codename:"UntMarine1",num:100,level:1,group:1},{codename:"UntMarine2",num:100,level:2,group:1},{codename:"UntMarine3",num:100,level:3,group:1},{codename:"UntMarine4",num:100,level:4,group:1},{codename:"UntMarine5",num:100,level:5,group:1},{codename:"UntMarine6",num:100,level:6,group:1},
			{codename:"UntSniper1",num:100,level:1,group:1},{codename:"UntSniper2",num:100,level:2,group:1},{codename:"UntSniper3",num:100,level:3,group:1},{codename:"UntSniper4",num:100,level:4,group:1},{codename:"UntSniper5",num:100,level:5,group:1},{codename:"UntSniper6",num:100,level:6,group:1},
			{codename:"UntHacker1",num:100,level:1,group:1},{codename:"UntHacker2",num:100,level:2,group:1},{codename:"UntHacker3",num:100,level:3,group:1},{codename:"UntHacker4",num:100,level:4,group:1},{codename:"UntHacker5",num:100,level:5,group:1},{codename:"UntHacker6",num:100,level:6,group:1},
			{codename:"UntCyber1",num:100,level:1,group:1},{codename:"UntCyber2",num:100,level:2,group:1},{codename:"UntCyber3",num:100,level:3,group:1},{codename:"UntCyber4",num:100,level:4,group:1},{codename:"UntCyber5",num:100,level:5,group:1},{codename:"UntCyber6",num:100,level:6,group:1},
			{codename:"UntTNTMac1",num:100,level:1,group:1},{codename:"UntTNTMac2",num:100,level:2,group:1},{codename:"UntTNTMac3",num:100,level:3,group:1},{codename:"UntTNTMac4",num:100,level:4,group:1},{codename:"UntTNTMac5",num:100,level:5,group:1},{codename:"UntTNTMac6",num:100,level:6,group:1},
			{codename:"UntChop1",num:100,group:1},{codename:"UntChop2",num:100,level:2,group:1},{codename:"UntChop3",num:100,level:3,group:1},{codename:"UntChop4",num:100,level:4,group:1},{codename:"UntChop5",num:100,level:5,group:1},{codename:"UntChop6",num:100,level:6,group:1},
			{codename:"UntTank1",num:100,level:1,group:1},{codename:"UntTank2",num:100,level:2,group:1},{codename:"UntTank3",num:100,level:3,group:1},{codename:"UntTank4",num:100,level:4,group:1},{codename:"UntTank5",num:100,level:5,group:1},{codename:"UntTank6",num:100,level:6,group:1},
			{codename:"UntHealer1",num:100,level:1,group:10},{codename:"UntHealer2",num:100,level:2,group:10},{codename:"UntHealer3",num:100,level:3,group:10},{codename:"UntHealer4",num:100,level:4,group:10},
			{codename:"UntAvenger1",num:100,level:1,group:1},{codename:"UntAvenger2",num:100,level:2,group:1},{codename:"UntAvenger3",num:100,level:3,group:1},{codename:"UntAvenger4",num:100,level:4,group:1},
			{codename:"UntPEKKA1",num:100,level:1,group:1},{codename:"UntPEKKA2",num:100,level:2,group:1},{codename:"UntPEKKA3",num:100,level:3,group:1},{codename:"UntPEKKA4",num:100,level:4,group:1},
			{codename:"Lightning1",num:100,level:1,group:4},{codename:"Heal1",num:100,level:1,group:5},{codename:"VVirus1",num:100,level:1,group:5},{codename:"ZGravity1",num:100,level:1,group:5},
			{codename:"UntUAV1",num:100,group:1},{codename:"UntUAV2",num:100,level:2,group:1},{codename:"UntUAV3",num:100,level:3,group:1},{codename:"UntUAV4",num:100,level:4,group:1},{codename:"UntUAV5",num:100,level:5,group:1},
			{codename:"UntRider1",num:100,group:1},{codename:"UntRider2",num:100,level:2,group:1},{codename:"UntRider3",num:100,level:3,group:1},{codename:"UntRider4",num:100,level:4,group:1},{codename:"UntRider5",num:100,level:5,group:1},
			{codename:"UntGolem1",num:100,group:1},{codename:"UntGolem2",num:100,level:2,group:1},{codename:"UntGolem3",num:100,level:3,group:1},{codename:"UntGolem4",num:100,level:4,group:1},{codename:"UntGolem5",num:100,level:5,group:1},
			{codename:"UntDoctor1",num:100,group:1},{codename:"UntDoctor2",num:100,level:2,group:1},
			//Spell
			];
		...
		this.lootCubeBox.setDisplay(stage.haveCubeBld?1:0);
...
/*********************************************************************/
		...
		__Page.stateBattle.showSettlement=function()//结算界面
		{
			...
			if(this.lootItemsBox)
				this.lootItemsBox.setDisplay(0);
