this.cssLib.menuBox=
{
	...
	createCSS:function(box,closeKey,pos,menuInfo,menuW,menuH)
	{
		...
		var dtX=6, dtY=6, dtItem=8;
		var i, cnt=menuInfo.length;
		var menuBoxW=dtX*2+menuW, menuBoxH=dtY*2+menuH*cnt+dtItem*(cnt-1);
		var pic=imgLib.getImg("pic_menu_arrow"), arrowScale=0.8, arrowW=Math.floor(pic.w*arrowScale), arrowH=Math.floor(pic.h*arrowScale);
		var menuBoxX=pos[0]+arrowW, menuBoxY=pos[1]-menuBoxH/2;
		var arrowX=menuBoxX+2, arrowY=pos[1];
		...
		var css={id:"close-menu",type:"key",pos:[0,0,0],w:box.getW(),h:box.getH(),ui_event:1,key:closeKey,state_up:{w:box.getW(),h:box.getH()},items:[
			{id:"menuBox",type:"div3x3",pos:[menuBoxX,menuBoxY,0],w:menuBoxW,h:menuBoxH,ui_event:1,css:imgLib.getImg("box_menu"),size3x3:[10,10,10,13],items:items,},
