this.cssLib.btnBtmReset=
{
	...
	createCSS:function(bld)
	{
		...
		css={
			type:"key",id:"BtmBtnReset","pos":[0,0,0],key:appEnv.appKeys.bldReset,"css":imgLib.btn_btmreset,"anchor_h":1,"anchor_v":1,ui_event:1,filter:1,button:1,down_scale:0.95,
			state_up:{"css":imgLib.btn_btmreset},audio:page.audioObject.genFileURL("btn_click"),
			state_down:{"css":imgLib.btn_btmreset,w:imgLib.btn_btmreset.w,h:imgLib.btn_btmreset.h},
			state_gray:{"css":imgLib.btn_btmreset,color_r:128,color_g:128,color_b:128,color_a:128},
	...
	isOK2Show:function(bld)
	{
		...
		if(!bld.constructing && bld.status==2)
		{
			return 1;
		}
		return 0;
