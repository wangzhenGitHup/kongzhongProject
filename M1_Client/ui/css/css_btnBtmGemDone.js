this.cssLib.btnBtmGemDone=
{
	...
	createCSS:function(bld)
	{
		...
		var pic=imgLib.getImg("btn_btmgemfin"),picInfo=imgLib.getImg("btn_btminfo"),picW=picInfo.w,picH=picInfo.h;
		...
		css={
			//TODO: 换图:
			type:"key",id:"BtmBtnGemDone",pos:[0,0,0],key:appEnv.appKeys.bldGemDone,css:pic,anchor_h:1,anchor_v:1,ui_event:1,filter:1,button:1,down_scale:0.95,
	...
	isOK2Show:function(bld)
	{
		var def,level;
		def=bld.def;
		if(bld.constructing==1 && def.levels[1] && !def.levels[1].removeResult)
		{
			return 1;
		}
		return 0;
