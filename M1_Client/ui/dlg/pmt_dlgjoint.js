...
//				color_r:10,color_g:10,color_b:10,color_a:200});
			...
			this.okBox=this.cntBox.appendNewChild({type:"div3x3",pos:[x,y,0],w:w,h:h,anchor_h:0,anchor_v:1,css:imgLib.getImg("box_green"),display:0,items:[
				{type:"icon",pos:[100,0,0],anchor_h:1,anchor_v:1,css:imgLib.getImg("pic_joint_bg"),},
				{type:"icon",pos:[100,0,0],anchor_h:1,anchor_v:1,css:picEmpty},
				{id:"item",type:"icon",pos:[100,0,0],anchor_h:1,anchor_v:1,css:imgLib.getIcon("plu_L4_09_32"),w:picEmpty.w,h:picEmpty.h},
				{id:"info",css:cssLib.textFineMid.createCSS([192,0,0],textLib["Wait"],260,h,0,1,0,1),wrap:1}
			]});
		}
	...
	__Page.pmtJoint.onSvrTimeout=function()
	{
		var appEnv=this.appEnv;
		var textLib=appEnv.textLib;
		if(this.timer)
		...
		this.midTxt._setText(textLib["ConnectTimeoutDesc"]);
		this.longTimer=null;
	};
