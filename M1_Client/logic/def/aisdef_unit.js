	...
	(function()
	{
		...
		defLib["UntMarine"]={
		 ...
		 levels:[
				...
				{cost:{time:10000,storage:[{store:"Oil",type:"ResOil",num:200}]},attack:37,hp:125,cocDefName:"UntMarine7",CostGem:1},
			]
		};
		...
		defLib["UntSniper"]={
		 ...
		 levels:[
				...
				{cost:{time:15000,storage:[{store:"Oil",type:"ResOil",num:400}]},attack:30,hp:56,cocDefName:"UntSniper7",CostGem:1},
			]
		};
		...
		defLib["UntHacker"]={
		 ...
		 levels:[
				...
				{cost:{time:15000,storage:[{store:"Oil",type:"ResOil",num:300}]},attack:48,hp:78,cocDefName:"UntHacker7",CostGem:1},
			]
		};
		...
		defLib["UntCyber"]={
		 ...
		 levels:[
				...
				{cost:{time:60000,storage:[{store:"Oil",type:"ResOil",num:3500}]},attack:49,hp:1030,cocDefName:"UntCyber7",CostGem:5},
			]
		};
		...
		defLib["UntTNTMac"]={
		 ...
		 levels:[
				...
				{cost:{time:60000,storage:[{store:"Oil",type:"ResOil",num:4000}]},attack:74,hp:66,cocDefName:"UntTNTMac7",CostGem:1},
			]
		};
		...
		defLib["UntChop"]={
		 ...
		 levels:[
				...
				{cost:{time:300000,storage:[{store:"Oil",type:"ResOil",num:4000}]},attack:180,hp:600,cocDefName:"UntChop7",CostGem:5},
			]
		};
		...
		defLib["UntTank"]={
		 ...
		 levels:[
				...
				{cost:{time:300000,storage:[{store:"Oil",type:"ResOil",num:4000}]},attack:210,hp:204,cocDefName:"UntTank7",CostGem:4},
			]
		};
		...
		defLib["UntHealer"]={
		 ...
		 levels:[
				...
				{cost:{time:600000,storage:[{store:"Oil",type:"ResOil",num:15000}]},attack:-60,hp:1100,cocDefName:"UntHealer5",CostGem:15},
			]
		};
		...
		defLib["UntAvenger"]={
		 ...
		 levels:[
				...
				{cost:{time:1200000,storage:[{store:"Oil",type:"ResOil",num:35000}]},attack:225,hp:2600,cocDefName:"UntAvenger5",CostGem:20},
			]
		};
		...
		defLib["UntPEKKA"]={
		 ...
		 levels:[
				...
				{cost:{time:1800000,storage:[{store:"Oil",type:"ResOil",num:50000}]},attack:360,hp:4200,cocDefName:"UntPEKKA5",CostGem:25},
			]
		};
		...
		defLib["UntWallBomb"]={
		 codeName:"UntWallBomb",type:"Unit",name:textLib.unitName["UntWallBomb"],desc:textLib.unitInfo["UntWallBomb"],svrCodeName:"UntWallBomb",
		 icon:"chr_UntWallBomb",move:0,
		 favor:textLib.bldInfo["favor_any"],target:textLib.bldInfo["target_gnd"],dmg_type:textLib.bldInfo["dmgtype_aoe"],
		 levels:[
				{cost:{time:1000,storage:[{store:"Cube",type:"ResCube",num:1}]},attack:1,hp:0,cocDefName:"UntWallBomb1",CostGem:0},
			]
		};
		window.aisEnv.defLib.hashFactors(defLib["UntWallBomb"]);

		defLib["UntAvengerDX"]={
		 codeName:"UntAvengerDX",type:"Unit",name:textLib.unitName["UntAvengerDX"],desc:textLib.unitInfo["UntAvengerDX"],svrCodeName:"UntAvengerDX",
		 icon:"chr_UntAvengerDX",storageSize:30,storageSave:30,bldLvReq:10,levelTech:"tchUnit15",move:160,
		 favor:textLib.bldInfo["favor_any"],target:textLib.bldInfo["target_all"],dmg_type:textLib.bldInfo["dmgtype_aoe"],
		 levels:[
				{cost:{gem:20,time:1200000,storage:[]},attack:450,hp:4200,cocDefName:"UntAvengerDX1",CostGem:20},
			]
		};
		window.aisEnv.defLib.hashFactors(defLib["UntAvengerDX"]);

		defLib.allUnits=["UntMarine","UntSniper","UntHacker","UntCyber","UntTNTMac","UntChop","UntTank","UntHealer","UntAvenger","UntPEKKA","UntUAV","UntRider","UntGolem","UntDoctor","UntAvengerDX",];
