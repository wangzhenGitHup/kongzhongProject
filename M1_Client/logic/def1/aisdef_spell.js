if(window.aisEnv.defLib && window.aisEnv.defLib.spell && !window.aisEnv.defLib.spell.inited)
{
	(function()
	{
		...
		defLib["EMPSpell"]={
		 codeName:"EMPSpell",type:"Spell",name:textLib.spellName["EMPSpell"],desc:textLib.spellInfo["EMPSpell"],svrCodeName:"EMPSpell",
		 icon:"spell_EMPSpell",storageSize:1,storageSave:1,bldLvReq:5,levelTech:"tchSpell5",
		 target:textLib.bldInfo["target_all"],dmg_type:textLib.bldInfo["dmgtype_aoe"],
		 levels:[
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:50000}]},attack:0,hp:0,cocDefName:"EMPSpell1"},
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:60000}]},attack:0,hp:0,cocDefName:"EMPSpell2"},
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:70000}]},attack:0,hp:0,cocDefName:"EMPSpell3"},
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:80000}]},attack:0,hp:0,cocDefName:"EMPSpell4"},
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:90000}]},attack:0,hp:0,cocDefName:"EMPSpell5"},
				{cost:{time:3600000,storage:[{store:"Gold",type:"ResGold",num:100000}]},attack:0,hp:0,cocDefName:"EMPSpell6"},
			]
		};
		window.aisEnv.defLib.hashFactors(defLib["EMPSpell"]);

		defLib.allSpells=["Lightning","Heal","VVirus","ZGravity","EMPSpell",];
	})();
}
